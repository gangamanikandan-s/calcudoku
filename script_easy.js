...
var replace1 = document.createElement("div");
var replace2 = document.createElement("div");
var replace3 = document.createElement("div");
var replace4 = document.createElement("div");
...
child.appendChild(replace1);
child.appendChild(replace2);
child.appendChild(replace3);
child.appendChild(replace4);
replace1.setAttribute("id", "replace1");
replace2.setAttribute("id", "replace2");
replace3.setAttribute("id", "replace3");
replace4.setAttribute("id", "replace4");
...
var cage3 = answerList[0][3];
document.getElementById("cage3").innerHTML = cage3.toString();
var cage4 = answerList[1][1]
document.getElementById("cage4").innerHTML = cage4.toString();
var cage5 = answerList[1][2] + answerList[1][3];
document.getElementById("cage5").innerHTML = cage5.toString() + "+";
var cage6 = answerList[2][0];
document.getElementById("cage6").innerHTML = cage6.toString();
var cage7 = answerList[2][1] + answerList[2][2];
document.getElementById("cage7").innerHTML = cage7.toString() + "+";

var cage8 = answerList[2][3] + answerList[3][3];
document.getElementById("cage8").innerHTML = cage8.toString() + "+";
var cage9 = answerList[3][0] + answerList[3][1];
document.getElementById("cage9").innerHTML = cage9.toString() + "+";
var cage10 = answerList[3][2];
document.getElementById("cage10").innerHTML = cage10.toString();
...
var col4 = [];
    ...
    if (rowa.size==4&&rowb.size==4&&rowc.size==4&&rowd.size==4&&cola.size==4&&colb.size==4&&colc.size==4&&cold.size==4){
        if (Number(document.getElementById("row1col1").value) + Number(document.getElementById("row2col1").value) == cage1 && Number(document.getElementById("row1col2").value) + Number(document.getElementById("row1col3").value) == cage2 && Number(document.getElementById("row1col4").value) == cage3 && Number(document.getElementById("row2col2").value) == cage4 && Number(document.getElementById("row2col3").value) + Number(document.getElementById("row2col4").value) == cage5 && Number(document.getElementById("row3col1").value) == cage6 && Number(document.getElementById("row3col2").value) + Number(document.getElementById("row3col3").value) == cage7 && Number(document.getElementById("row3col4").value) + Number(document.getElementById("row4col4").value) == cage8 && Number(document.getElementById("row4col1").value) + Number(document.getElementById("row4col2").value) == cage9 && Number(document.getElementById("row4col3").value) == cage10) {
            winning()
        ...
        endTime= (new Date().getTime())+hintPress;
...
function hint(){
  ...
  console.log(random_row+""+random_col)
   ...
   if(random_row==4&&random_col==4){
    document.getElementById("row4col4").style.borderTop = "6px solid #ddd";
