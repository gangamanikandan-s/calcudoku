...
var cage2 = answerList[0][1] + answerList[1][1]+answerList[1][2]+answerList[2][1]+answerList[2][2];
document.getElementById("cage2").innerHTML = cage2.toString() + "+";
var cage3 = answerList[0][2]*answerList[0][3];
document.getElementById("cage3").innerHTML = cage3.toString()+"×";
var cage4 = answerList[1][3]+answerList[2][3];
document.getElementById("cage4").innerHTML = cage4.toString()+"+";
var cage5 = answerList[2][0] + answerList[3][0]+answerList[3][1];
document.getElementById("cage5").innerHTML = cage5.toString() + "+";
var cage6 = answerList[3][2]*answerList[3][3];
...
var col4 = [];
    ...
    if (rowa.size==4&&rowb.size==4&&rowc.size==4&&rowd.size==4&&cola.size==4&&colb.size==4&&colc.size==4&&cold.size==4){
        ...
        console.log(Number(document.getElementById("row1col2").value) +Number(document.getElementById("row2col2").value)+ Number(document.getElementById("row2col3").value)+Number(document.getElementById("row3col2").value)+ Number(document.getElementById("row3col3").value) == cage2)
        console.log(Number(document.getElementById("row1col3").value)*Number(document.getElementById("row1col4").value) == cage3)
        console.log(Number(document.getElementById("row2col4").value) + Number(document.getElementById("row3col4").value) == cage4)
        console.log(Number(document.getElementById("row3col1").value)+Number(document.getElementById("row4col1").value)+Number(document.getElementById("row4col2").value) == cage5)
        console.log(Number(document.getElementById("row4col3").value) * Number(document.getElementById("row4col4").value) == cage6);
        if (Number(document.getElementById("row1col1").value) + Number(document.getElementById("row2col1").value) == cage1 && Number(document.getElementById("row1col2").value) +Number(document.getElementById("row2col2").value)+ Number(document.getElementById("row2col3").value)+Number(document.getElementById("row3col2").value)+ Number(document.getElementById("row3col3").value) == cage2 && Number(document.getElementById("row1col3").value)*Number(document.getElementById("row1col4").value) == cage3 && Number(document.getElementById("row2col4").value) + Number(document.getElementById("row3col4").value) == cage4 && Number(document.getElementById("row3col1").value)+Number(document.getElementById("row4col1").value)+Number(document.getElementById("row4col2").value) == cage5 && Number(document.getElementById("row4col3").value) * Number(document.getElementById("row4col4").value) == cage6) {
           console.log("win");
            winning()
...
function winning() {
    ...
    document.getElementById("row4col1").style.borderTop = "6px solid #ddd";
    document.getElementById("row3col4").style.borderTop = "6px solid #ddd";
    ...
    document.getElementById("row2col2").style.borderTop = "6px solid #ddd";
    ...
    document.getElementById("row1col4").style.borderLeft = "6px solid #ddd";
    document.getElementById("row2col3").style.borderLeft = "6px solid #ddd";
    document.getElementById("row3col3").style.borderLeft = "6px solid #ddd";
